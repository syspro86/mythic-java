...
(
    ...
    CONSTRAINT MYTHIC_RECORD_PLAYER_PK PRIMARY KEY (ID)
)
;
...
;
CREATE INDEX MYTHIC_PLAYER_INDEX_LASTUPDATETS ON MYTHIC_PLAYER(LAST_UPDATE_TS);
;
...
(
    ...
    CONSTRAINT PLAYER_SPEC_PK PRIMARY KEY (ID)
)
;
